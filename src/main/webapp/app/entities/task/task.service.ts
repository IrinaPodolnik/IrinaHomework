...
export class TaskService {
    ...
    private convertDateFromClient(task: ITask): ITask {
        const copy: ITask = Object.assign({}, task, {
            assignDate: task.assignDate != null && task.assignDate.isValid() ? task.assignDate.format(DATE_FORMAT) : null,
    ...
    private convertDateFromServer(res: EntityResponseType): EntityResponseType {
        res.body.assignDate = res.body.assignDate != null ? moment(res.body.assignDate) : null;
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((task: ITask) => {
            task.assignDate = task.assignDate != null ? moment(task.assignDate) : null;
